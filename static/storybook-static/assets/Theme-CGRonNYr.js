import"./preload-helper-Dr7BywEQ.js";import{c as e}from"./iframe-BQMB58IQ.js";import{t}from"./jsx-runtime-D9pC4uRa.js";import{n}from"./lib-CYZwGeqP.js";import"./dist-CnOHJpVQ.js";import"./components-oAqG0Y6W.js";import"./react-dom-CFpWYkGV.js";import{c as r,l as i}from"./blocks-DWL5brVL.js";var a=e(t()),o=`/**
 * BrowserAct UI 主题变量
 *
 * 使用方式：
...
`;function s(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r,{title:`Theme System`}),`
...
@import 'tw-animate-css'; /* 动画支持（Tooltip 等组件需要）*/
@import 'browseract-ui/theme.css';

/* 扫描 browseract-ui 源码以提取 cva 动态类名 */
@source '../../node_modules/browseract-ui/src/**/*.{ts,tsx}';
`})}),`
`,(0,a.jsxs)(t.blockquote,{children:[`
`,(0,a.jsxs)(t.p,{children:[(0,a.jsx)(t.strong,{children:`注意`}),`：`,(0,a.jsx)(t.code,{children:`@source`}),` 路径需要根据你的 CSS 文件位置调整。上面的示例假设 CSS 文件位于 `,(0,a.jsx)(t.code,{children:`app/globals.css`}),`。`]}),`
`]}),`
